      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto text-lg">
            Pricing is based on the number of AI chatbots (agents) you deploy.
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {pricingTiers.map((tier, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-3xl bg-background/60 backdrop-blur-sm border border-border/50 hover:border-transparent transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 flex flex-col h-full"
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <button className="w-full mt-auto group relative px-10 py-4 bg-white text-[#003893] font-semibold rounded-full overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-[#DC143C]/30 hover:scale-105">
