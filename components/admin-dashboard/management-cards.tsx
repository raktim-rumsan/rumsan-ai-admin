  ...
  export const managementCardItem = [
    {
      ...
      description: "Manage your organization settings, branding, and general configuration",
      icon: Building2,
    ...
    },
    {
      ...
      description: "Create and manage workspaces for different teams and projects",
      icon: FolderKanban,
    ...
    },
    {
      ...
      description: "View your subscription plan, usage, and manage payment methods",
      icon: CreditCard,
